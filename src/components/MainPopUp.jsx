...
export default function MainPopUp() {
  ...
  return (
    <div
      ...
      onClick={handlePopupClick}
    >
      <div className="bg-white rounded-xl sm:rounded-xl md:rounded-2xl w-full max-w-sm xs:max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl mx-3 sm:mx-4 relative animate-popup-slide-up shadow-2xl max-h-[85vh] sm:max-h-[88vh] md:max-h-[90vh] flex flex-col my-4 sm:my-6">
        {/* Close button */}
        <button
          // onClick={closePopup}
          className="absolute top-3 right-3 sm:top-3 sm:right-3 md:top-4 md:right-4 text-gray-400 hover:text-gray-600 transition-colors duration-200 z-10 p-1.5 sm:p-2 rounded-full hover:bg-gray-100 touch-manipulation"
          aria-label="Close popup"
        >
          <X size={18} className="sm:w-5 sm:h-5 md:w-6 md:h-6" />
        </button>
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 sm:p-4 md:p-5 rounded-t-xl sm:rounded-t-xl md:rounded-t-2xl flex-shrink-0">
          <div className="flex items-center space-x-2 sm:space-x-3">
            {/* <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center flex-shrink-0">
              <Shield size={16} className="sm:w-5 sm:h-5 md:w-6 md:h-6" />
            </div> */}
        ...
        {/* Content - Scrollable */}
        <div className="p-4 sm:p-4 md:p-5 overflow-y-auto flex-1 space-y-4 sm:space-y-4">
          {/* Why you're seeing alerts */}
          <div>
            ...
            <div className="bg-orange-50 rounded-lg p-3 sm:p-3 space-y-2 sm:space-y-2">
              <p className="text-gray-700 text-xs sm:text-sm md:text-base leading-relaxed">
                <span className="font-semibold">1. Unusual Sign-In:</span> Logins from unexpected locations
              </p>
              <p className="text-gray-700 text-xs sm:text-sm md:text-base leading-relaxed">
          ...
          <div>
            ...
            <div className="bg-green-50 rounded-lg p-3 sm:p-3 space-y-2 sm:space-y-3">
              <div className="flex items-start space-x-2 sm:space-x-3">
                <div className="w-5 h-5 sm:w-6 sm:h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-600 font-bold text-xs sm:text-sm">1</span>
                </div>
          ...
          {/* Important note */}
          <div>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-3 sm:p-3 rounded-r-lg">
              <div className="flex items-start space-x-2">
                <HelpCircle size={14} className="sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                <div className="min-w-0 flex-1">
                  <p className="text-blue-800 text-xs sm:text-sm leading-relaxed">
        ...
        {/* Call Now Button - Fixed at bottom */}
        <div className="p-4 sm:p-4 md:p-5 pt-0 flex-shrink-0">
          <button
            onClick={handleCallNow}
            className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 active:from-blue-800 active:to-blue-900 text-white py-3 sm:py-3.5 md:py-4 px-4 rounded-lg flex items-center justify-center space-x-2 transform hover:scale-105 active:scale-95 transition-all duration-300 shadow-lg font-semibold text-sm sm:text-base touch-manipulation min-h-[44px] sm:min-h-[48px]"
          >
